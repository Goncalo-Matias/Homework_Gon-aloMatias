...
I will implement a camera-trapping scheme across nine sampling areas in Central Portugal. These sampling areas will include six Eucalyptus-dominated landscapes (three areas with FSC certification and three without) and three native vegetation control areas (e.g., protected areas with native species).
...
*Figure 1.* Example of an activity pattern of wild boar (Sus scrofa).   

![](https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs13364-022-00632-8/MediaObjects/13364_2022_632_Fig2_HTML.png?as=webp)
